...
var completedTasksHolder = document.getElementById("task__list--completed"); //task__list--completed
...
var createNewTaskElement = function (taskString) {
  ...
  label.classList.add("task__label", "task__item--edit");
  //input (text)
  var editInput = document.createElement("input"); //text
  editInput.type = "text";
  editInput.classList.add("task__label", "task__input");
  //button.edit
  var editButton = document.createElement("button"); //edit button
  editButton.innerText = "Edit";
  editButton.classList.add("task__button--edit", "task__button");

  //button.delete
  var deleteButton = document.createElement("button"); //delete button
  deleteButton.classList.add("task__button--delete", "task__button");
